...
#ifndef __UNIRTOS_MEM_PARTION_718PM_OPEN_H__
#define __UNIRTOS_MEM_PARTION_718PM_OPEN_H__
...
这意味着这三个分区的总大小保持不变，增大其中一个分区时，必须相应减少其他分区的容量。
 ...
 * First 分配各个FLASH分区大小
 */
#if defined(QL_OEM_VERSION_POC)
#define UNIR_AP_IMG_SIZE        (0x1D6000)
#define UNIR_APP_OPEN_CPU_SIZE  (0xC8000)
#define UNIRTOS_CUST_FLASH_SIZE (0x0)
#define UNIR_LFS_SIZE           (0xA1000)
#define UNIR_UPDATER_SIZE       (0X24000)
#define UNIR_HIB_BACKUP_SIZE    (0x0)

#elif defined(QL_OEM_VERSION_BDA)
#define UNIR_AP_IMG_SIZE        (0x1C0000)
#if defined QL_CP_OC_GLO_BIN_MODE
/* GLO: AP_PARTION_START多了0x5000, NVRAM多了0xD000, 共需减少0x12000 */
#define UNIR_APP_OPEN_CPU_SIZE  (0x15B000)
#else
#define UNIR_APP_OPEN_CPU_SIZE  (0x16D000)
#endif /* QL_CP_OC_GLO_BIN_MODE */
#define UNIRTOS_CUST_FLASH_SIZE (0x0)
#define UNIR_LFS_SIZE           (0x12000)
#define UNIR_UPDATER_SIZE       (0X24000)
#define UNIR_HIB_BACKUP_SIZE    (0x0)

#elif defined(QL_OEM_VERSION_SMS)
#define UNIR_AP_IMG_SIZE        (0x21D000)
#if defined QL_CP_OC_GLO_BIN_MODE
/* GLO: AP_PARTION_START多了0x5000, NVRAM多了0xD000, 共需减少0x12000 */
#define UNIR_APP_OPEN_CPU_SIZE  (0xC8000)
#else
#define UNIR_APP_OPEN_CPU_SIZE  (0xDA000)
#endif /* QL_CP_OC_GLO_BIN_MODE */
#define UNIRTOS_CUST_FLASH_SIZE (0x0)
#define UNIR_LFS_SIZE           (0x48000)
#define UNIR_UPDATER_SIZE       (0X24000)
#define UNIR_HIB_BACKUP_SIZE    (0x0)

#elif defined(QL_OEM_VERSION_ALI)
#define UNIR_AP_IMG_SIZE        (0x1a6000)
#if defined QL_CP_OC_GLO_BIN_MODE
/* GLO: AP_PARTION_START多了0x5000, NVRAM多了0xD000, 共需减少0x12000 */
#define UNIR_APP_OPEN_CPU_SIZE  (0x1A2000)
#else
#define UNIR_APP_OPEN_CPU_SIZE  (0x1b4000)
#endif /* QL_CP_OC_GLO_BIN_MODE */
#define UNIRTOS_CUST_FLASH_SIZE (0x0)
#define UNIR_LFS_SIZE           (0x9000)
#if defined (QOSA_EXT_UPDATER_SUPPORT)
#define UNIR_UPDATER_SIZE       (0x0)
#else
#define UNIR_UPDATER_SIZE       (0X24000)
...
//2.原厂特性,各lib下的公版
#elif defined(QL_AP_LIB_OC)
#ifndef __QUECTEL_PROJECT_EG800ZCN_LG__
//公版非GNSS项目分区划分
#define UNIR_AP_IMG_SIZE        (0x1D6000)
#define UNIR_APP_OPEN_CPU_SIZE  (0xC8000)
#define UNIRTOS_CUST_FLASH_SIZE (0x0)
#define UNIR_LFS_SIZE           (0x89000)
#define UNIR_UPDATER_SIZE       (0X24000)
#define UNIR_HIB_BACKUP_SIZE    (0x18000)
#else /* __QUECTEL_PROJECT_EG800ZCN_LG__ */
//公版GNSS项目分区划分
#define UNIR_AP_IMG_SIZE        (0x1D6000)
#define UNIR_APP_OPEN_CPU_SIZE  (0xC8000)
#define UNIRTOS_CUST_FLASH_SIZE (0x0)
#define UNIR_LFS_SIZE           (0x59000)
#define UNIR_GNSS_IMG_SIZE      (0x30000)
#define UNIR_UPDATER_SIZE       (0X24000)
#define UNIR_HIB_BACKUP_SIZE    (0x18000)
#endif /* __QUECTEL_PROJECT_EG800ZCN_LG__ */
#elif defined(QL_AP_LIB_OC_GLO)
#define UNIR_AP_IMG_SIZE        (0x1D6000)
#define UNIR_APP_OPEN_CPU_SIZE  (0xC8000)
#define UNIRTOS_CUST_FLASH_SIZE (0x0)
#define UNIR_LFS_SIZE           (0x77000)
#define UNIR_UPDATER_SIZE       (0X24000)
#define UNIR_HIB_BACKUP_SIZE    (0x18000)
#else
...
#if defined(QL_OEM_VERSION_SMS)
#define UNIR_AP_IMG_UNZIP_SIZE       (0x26D000)
#else
#define UNIR_AP_IMG_UNZIP_SIZE       (0x1F8000)
#endif
 ...
 */
#define UNIRTOS_PSRAM_END_ADDR       0x0c400000
...
#define UNIR_GNSS_IMG_ADDR     (UNIR_AP_IMG_ADDR + UNIR_AP_IMG_SIZE)
#define UNIR_APP_OPEN_CPU_ADDR (UNIR_GNSS_IMG_ADDR + UNIR_GNSS_IMG_SIZE)
#else  /* __QUECTEL_PROJECT_EG800ZCN_LG__ */
...
#endif /* __UNIRTOS_FLASH_PARTION_718PM_OPEN_H__ */
