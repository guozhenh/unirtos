...
#ifdef QL_SIO_SUPPORT
typedef struct{
    UINT8      channID;
    UINT8      status;
}dtr_status;
#endif /* QL_SIO_SUPPORT */
...
typedef enum _SIG_EPAT_cmsSigId_Enum
{
    ...
    */
    ...
    // Start of CMS signal received from CP
    SIG_CMS_APMU_SC_CALIBR_REQ,     // C2A_SLOWCLOCK_CALIBR_REQ
    SIG_CMS_APMU_SC_CALIBR_CANCEL_REQ, // C2A_SLOWCLOCK_CALIBR_CANCEL_REQ
...
#ifdef QL_SIO_SUPPORT
    SIG_CMS_DTR_STATUS_CHG_IND = 0x0970,
#endif /* QL_SIO_SUPPORT */
    ...
    */
    ...
    SIG_CUSTOMER_CNF,
    SIG_CUSTOMER_IND,
#ifdef QL_UNIRTOS_SUPPORT
    SIG_UNIRTOS_AT_EVENT,    // unirtos at event
#endif /* QL_UNIRTOS_SUPPORT */
