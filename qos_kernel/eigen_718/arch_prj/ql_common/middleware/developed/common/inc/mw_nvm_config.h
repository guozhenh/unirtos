...
typedef enum _EPAT_MidWareCfgParamId_Enum
{
    ...
    MW_CFG_URC_RI_RING_INCOMING_PARAM, /* TLV, MWNvmCfgUrcRIRingIncomingParam * MID_WARE_USED_AT_CHAN_NUM */
    ...
    MW_CFG_NET_HSOT_EX_INFO_PARAM,     /* TLV, MWNvmCfgNetHostExInfoParam */
    
	MW_CFG_MUECONFIG_PARAM,         /* TLV, MWNvmCfgMueconfigParam */

    MW_CFG_DM_CMCC_REF_CR_PARAM,    /* TLV, MWNvmCfgDmCmccParam3 */
    MW_CFG_CEREG_URC,               /* TV, UINT8 ceregUrc */
    MW_CFG_CPNER_REPORTING_CFG,     /* TV, UINT8 cpnerRpt */
#ifdef UNIRTOS_PLATFORM_MODIFY
    MW_CFG_AT_CHAN_1_CONFIG_2 = (MW_CFG_PARAM_BASE + 0x100 - 1) - 7,        /* TLV,  QUECTEL MWNvmCfgAtChanConfig, AT channel 1 */
    MW_CFG_AT_CHAN_2_CONFIG_2 = (MW_CFG_PARAM_BASE + 0x100 - 1) - 6,        /* TLV,  QUECTEL MWNvmCfgAtChanConfig, AT channel 2 */
    MW_CFG_AT_CHAN_3_CONFIG_2 = (MW_CFG_PARAM_BASE + 0x100 - 1) - 5,        /* TLV,  QUECTEL MWNvmCfgAtChanConfig, AT channel 3 */
    MW_CFG_AT_CHAN_4_CONFIG_2 = (MW_CFG_PARAM_BASE + 0x100 - 1) - 4,        /* TLV,  QUECTEL MWNvmCfgAtChanConfig, AT channel 4 */
    // new extended at channnels
    MW_CFG_AT_CHAN_5_CONFIG_2 = (MW_CFG_PARAM_BASE + 0x100 - 1) - 3,        /* TLV,  QUECTEL MWNvmCfgAtChanConfig, AT channel 5 */
    MW_CFG_AT_CHAN_6_CONFIG_2 = (MW_CFG_PARAM_BASE + 0x100 - 1) - 2,        /* TLV,  QUECTEL MWNvmCfgAtChanConfig, AT channel 6 */
    MW_CFG_AT_CHAN_7_CONFIG_2 = (MW_CFG_PARAM_BASE + 0x100 - 1) - 1,        /* TLV,  QUECTEL MWNvmCfgAtChanConfig, AT channel 7 */
...
#ifdef UNIRTOS_PLATFORM_MODIFY
typedef MWCfgAtChanConfig_2   MWNvmCfgAtChanConfig_2;
#endif /* UNIRTOS_PLATFORM_MODIFY */
...
typedef struct _SIG_EPAT_MW_CFG_NET_PARAM
{
    ...
    UINT8    bNetDevCtlUrc;  /* whether report netdevctl urc: +ECNETDEVCTL, broadcast URC *//*1 -->ECNETDEVCTL, 2-->MDIALUP*/
 ...
 * paramId: MW_CFG_NET_HSOT_INFO_PARAM
*/
typedef struct _SIG_EPAT_MW_CFG_NET_HOST_EX_INFO_PARAM
{
    UINT8 hostIp4AddrStart;
    UINT8 hostIp4AddrEnd;
    UINT16 rsvd;
    UINT32 leaseTime;
}MWNvmCfgNetHostExInfoParam;     //16 bytes
...
#if defined FEATURE_REF_AT_CR_ENABLE && defined FEATURE_CMCC_DM_ENABLE
/*
 * DM CMCC ref cr ext parameter
*/
typedef struct _SIG_EPAT_MW_CFG_DM_CMCC_REF_CR_PARAM
{
    CHAR    host[49];
    CHAR    appkey[17];
    CHAR    password[49];
    ...
    UINT8   tmType:2;
    UINT8   enableFlag:1;
    UINT8   bConnected:1;       /*bConnected  0:no register 1: has register*/
    UINT16  port;
    INT32   wearing;
    UINT16  updatePeriod;
}MWNvmCfgDmCmccParam3;
#endif
...
/*
 * URC RI RING incoming param config
 * paramId: MW_CFG_URC_RI_RING_INCOMING_PARAM
*/
typedef struct _SIG_EPAT_MW_CFG_URC_RI_RING_INCOMING_PARAM
{
    UINT8       type;           // RI behavior when URCs are present. 0 - off, 1 - pulse.
    UINT8       pulseCount;     // The count of pulse, when type is 1.
    UINT16      pulseDuration;  // in unit of ms, The duration/width of pulse, when type is 1.
}MWNvmCfgUrcRIRingIncomingParam; //4 bytes

/*
 * URC RI RING incoming param config
 * paramId: MW_CFG_URC_RI_RING_INCOMING_PARAM
*/
typedef struct _SIG_EPAT_MW_CFG_URC_RI_SIGNAL_TYPE_PARAM
{
    UINT16   signalType;
    UINT16   rsvd;
}MWNvmCfgUrcRISignalTypeParam;
...
/*
 * MUECONFIG config param
 * paramId: MW_CFG_MUECONFIG_PARAM
*/
typedef struct _SIG_EPAT_MW_CFG_MUECONFIG_PARAM
{
    UINT32  autoconn : 1;
    UINT32  spare : 31;
}MWNvmCfgMueconfigParam;     //4 bytes
...
typedef struct MidWareNvmConfig_Tag
{
...
#ifdef UNIRTOS_PLATFORM_MODIFY
    /*
	 * AT channel NVM config 2, ParamId: MW_CFG_AT_CHAN_1_CONFIG/...
	*/
    MWNvmCfgAtChanConfig_2 atChanConfig_2[MID_WARE_USED_AT_CHAN_NUM];  //10*4 bytes
#endif /* UNIRTOS_PLATFORM_MODIFY */
    ...
    */
    ...
    /*
    * used for RI behavior when ring incoming URCS are presented, paramId: MW_CFG_URC_RI_Ring_INCOMING_PARAM
    */
    MWNvmCfgUrcRIRingIncomingParam   urcRIRingIncomingParamCfg[MID_WARE_USED_AT_CHAN_NUM];    // 16 bytes
    ...
    */
    ...
    /*MW_CFG_NET_HSOT_EX_INFO_PARAM*/
    MWNvmCfgNetHostExInfoParam      netParamHostExInfoCfg; //8 bytes
	/*
    * used for specified the output carrier of RI when URC is presented, paramId: MW_CFG_URC_RI_SIGNAL_TYPE_PARAM
    */
	MWNvmCfgUrcRISignalTypeParam    urcSignalTypeParamCfg;
    /*
    ...
    */
    ...
    MWNvmCfgMueconfigParam      mUeConfig;
    /*
    * used for cmcc dm, paramId: MW_CFG_DM_CMCC_REF_CR_PARAM
    */
#if defined FEATURE_REF_AT_CR_ENABLE && defined FEATURE_CMCC_DM_ENABLE
    MWNvmCfgDmCmccParam3        dmCmccParam3;
#endif
...
******************************************************************************/
#ifdef UNIRTOS_PLATFORM_MODIFY
void mwCfgDefaultAtChanConfig(UINT8 atChanId, MWNvmCfgAtChanConfig *pATChanConfig, MWNvmCfgAtChanConfig_2 *pATChanConfig_2);
...
/**
  \fn           void mwNvmCfgGetAllAtChanConfig(MWNvmCfgAtChanConfig *pAtChanConfig, MWNvmCfgAtChanConfig_2 *pAtChanConfig_2)
  \brief        Get atChanConfig
  \param[out]   MWNvmCfgAtChanConfig *pAtChanConfig
  				MWNvmCfgAtChanConfig_2 *pAtChanConfig_2
  \returns      config value
*/
void mwNvmCfgGetAllAtChanConfig(MWNvmCfgAtChanConfig *pAtChanConfig, MWNvmCfgAtChanConfig_2 *pAtChanConfig_2);

/**
  \fn           UINT32 mwNvmCfgSetAndSaveAllAtChanConfig(MWNvmCfgAtChanConfig *pAtChanConfig, MWNvmCfgAtChanConfig_2 *pAtChanConfig_2)
  \brief        Set And Save atChanConfig
  \param[in]    MWNvmCfgAtChanConfig *pAtChanConfig
  				MWNvmCfgAtChanConfig_2 *pAtChanConfig_2
  \returns      config value
*/
void mwNvmCfgSetAndSaveAllAtChanConfig(MWNvmCfgAtChanConfig *pAtChanConfig, MWNvmCfgAtChanConfig_2 *pAtChanConfig_2);
...
#if defined FEATURE_REF_AT_CR_ENABLE && defined FEATURE_CMCC_DM_ENABLE
void mwNvmCfgGetDmCmccParam3(MWNvmCfgDmCmccParam3 *pDmCmccParam3);
void mwNvmCfgSetAndSaveDmCmccParam3(MWNvmCfgDmCmccParam3 *pDmCmccParam3);
#endif
...
#if 0   //refer: mwNvmCfgGetEcSocketConfig
void mwGetEcSocPublicConfig(UINT8 *mode, UINT8 *publicDlPkgNumMax, UINT16 *publicDlBufferToalSize);
void mwSetEcSocPublicConfig(UINT8 mode, UINT8 publicDlPkgNumMax, UINT16 publicDlBufferToalSize);
#endif
...
void mwNvmCfgSetAndSaveNetParamHostInfoConfig(MWNvmCfgNetHostInfoParam *pNetParamHostInfoCfg);
void mwNvmCfgGetNetParamHostExInfoConfig(MWNvmCfgNetHostExInfoParam *pNetParamHostExInfoCfg);
void mwNvmCfgSetAndSaveNetParamHostExInfoConfig(MWNvmCfgNetHostExInfoParam *pNetParamHostExInfoCfg);
...
#ifdef FEATURE_PS_REF_CR_EPS_AT_ENABLE
void mwNvmCfgSetAndSaveMueCfgAutoconn(BOOL autoconn);
BOOL mwNvmCfgGetMueCfgAutoConn(void);
void mwNvmCfgSetAndSaveCeregUrc(UINT8 ceregUrc);
BOOL mwNvmCfgGetCeregUrc(void);
#endif

void mwNvmCfgSetAndSaveCpnerRpt(UINT8 cpnerRpt);
UINT8 mwNvmCfgGetCpnerRpt(void);
