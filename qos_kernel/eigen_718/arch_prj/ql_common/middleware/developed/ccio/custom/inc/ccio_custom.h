...
typedef enum
{
	...
	QUEC_CSIO_UART_0_PORT,
	QUEC_CSIO_UART_1_PORT,
	QUEC_CSIO_UART_2_PORT,
#ifdef UNIRTOS_OPEN_MODE_SUPPORT
    QUEC_CSIO_UART_3_PORT,
	QUEC_CSIO_USB_ACM_PORT,
    /* Already to 8 --- Can not add more */
    CSIO_OCF_MUX_BASE = 8,
#else /* UNIRTOS_OPEN_MODE_SUPPORT */

#ifdef __QUECTEL_PROJECT_EG800ZCN_LG__
    QUEC_CSIO_USB_NMEA_PORT,
    CSIO_OCF_MUX_BASE = 8,
...
int32_t spidExecCustInstr(uint32_t flags, void *args);
