...
#ifdef QL_SSL_SUPPORT
#define MBEDTLS_SSL_MAX_OUT_CONTENT_LEN         16384   /**< Size of the input / output buffer */
#endif /* QL_SSL_SUPPORT */
...
#define MBEDTLS_SSL_OUT_CONTENT_LEN MBEDTLS_SSL_MAX_OUT_CONTENT_LEN //EC modify
#endif
...
struct mbedtls_ssl_context {
    ...
    unsigned char rai;     /*!< EC add for RAI  */
#ifdef CONFIG_QOSA_MBEDTLS_MEMORY_OPTIMIZTAION_SUPPORT
    uint8_t mfl_accepted;        /*!< 最大片段长度扩展是否已接受 */
...
#ifdef QL_SSL_SUPPORT
void ql_mbedtls_ssl_conf_set_ignore_invalid_certsign_value( mbedtls_ssl_config *conf, int ignore_cert_flag);
#endif /* QL_SSL_SUPPORT */

#ifdef CONFIG_QOSA_MBEDTLS_MEMORY_OPTIMIZTAION_SUPPORT
int quectel_handle_buffer_resizing(mbedtls_ssl_context *ssl, int downsizing, size_t in_buf_new_len, size_t out_buf_new_len);
#endif /* CONFIG_QOSA_MBEDTLS_MEMORY_OPTIMIZTAION_SUPPORT */
