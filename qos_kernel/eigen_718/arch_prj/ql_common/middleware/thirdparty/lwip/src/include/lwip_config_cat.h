...
#define PS_MM_UL_MAX_TOTAL_BUFFER_SIZE  9*1024   //used for UL IP PKG, control the total UL pkg buffer, just system dynamic heap memory
...
#define TCPIP_MAX_IP_PKG_DUMP_LEN   1460
#else /* UNIRTOS_LWIP_MODIFY */
...
#ifdef UNIRTOS_LWIP_MODIFY
#define TCPIP_MAX_ETH_PKG_DUMP_LEN  1460
#else /* UNIRTOS_LWIP_MODIFY */
/*define dump log ETHER packet max size*/
...
// quectel modify
#define CONFIG_UNIR_PROJECT_FEATURE_SOCKET 1
// quectel modify
...
#define LWIP_LAN_NAT_HOST_IP_REAL_CHANGE 0
#else
...
#define LWIP_LAN_RNDIS_HOST_PRIVATE_IPV4_ADDRESS "192.168.10.2"

#define LWIP_LAN_RNDIS_PRIAVTE_IP_DNS_RELAY_SERVER_1 "192.168.10.3"

#define LWIP_LAN_RNDIS_PRIAVTE_IP_DNS_RELAY_SERVER_2 "192.168.10.4"

 /*PPP lan netif local ipv4 address*/
#define LWIP_LAN_PPP_LOCAL_IPV4_ADDRESS "192.168.20.1"

#define LWIP_LAN_PPP_HOST_PRIVATE_IPV4_ADDRESS "192.168.20.2"

#define LWIP_LAN_PPP_PRIAVTE_IP_DNS_RELAY_SERVER_1 "192.168.20.3"

#define LWIP_LAN_PPP_PRIAVTE_IP_DNS_RELAY_SERVER_2 "192.168.20.4"
...
#if defined(QL_NB_SUPPORT) || defined(QL_BJU_SUPPORT)
#define NM_PDN_TYPE_MAX_DNS_NUM     4
#else
...
#ifdef QL_CNK_SUPPORT
#define PBUF_POOL_SIZE                  30
#else /* QL_CNK_SUPPORT */
#define PBUF_POOL_SIZE                  8
#endif /* QL_CNK_SUPPORT */
#endif
...
#ifdef QL_CNK_SUPPORT
#define TCP_WND                         (30 * 1024) //30*TCP_MSS
#else /* QL_CNK_SUPPORT */
...
#ifdef UNIRTOS_LWIP_MODIFY
#define TCP_DEFRTX_TOTAL_TIME                      90
#else /* UNIRTOS_LWIP_MODIFY */
