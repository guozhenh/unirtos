...
*/
typedef struct CerrRrcBarTimeCfgTag
{
    ...
    //Used for cell barTime when receive 'unreliable' indication, and meanwhile UE has not yet collected SIB3 or SIB5 in QualityFirst mode
