...
uint16_t usbd_endpoint_maxpacket_size(usb_endpoint_descriptor_st  * p_endp_d);


#define EPADDR_FROM_DESC(p_ep_d) (p_ep_d->bEndpointAddress)
#define EPIDX_FROM_DESC(p_ep_d) ((p_ep_d->bEndpointAddress)&0x7f)
