...
#define EC_EXCEP_INFO_PART_NUM_PLAT       EC_EXCEP_INFO_PART_4
...
typedef enum _EPAT_Flash_Dump_Enums
{
    ...
    EPAT_PLAT_stack_Psp                = 0x3,
    EPAT_PLAT_stack_Msp                = 0x4,

    /* PS */
    EPAT_PS_MmGlobals                  = 0x5,
    EPAT_PS_CesmCommInfo               = 0x6,
    EPAT_PS_CesmTinyCtx                = 0x7,
    EPAT_PS_CesmBrTinyCtx              = 0x8,
    EPAT_PS_CesmEpsBrBasic             = 0x9,
    EPAT_PS_EpsNetworkFeatureSupport   = 0xa,

    /* PS RRC */
    EPAT_PS_PART8_CeRrcBootContext              = 0xb,
    EPAT_PS_PART9_CeRrcState_UeId               = 0xc,
    EPAT_PS_PART10_ServingCellInfo              = 0xd,
    EPAT_PS_PART11_CerrcCellLockContext         = 0xe,
    EPAT_PS_PART12_CerrcPlmnSearchContext       = 0xf,
    EPAT_PS_PART12_CerrcCellSearchContext       = 0x10,
    EPAT_PS_PART12_CerrcCellReselTargetCellInfo = 0x11,
    EPAT_PS_PART12_CerrcConnReEstContext        = 0x12,
    EPAT_PS_PART12_CerrcHandoverContext         = 0x13,
    EPAT_PS_PART12_CerrcConnReleaseContext      = 0x14,
    EPAT_PS_PART12_CerrcConnMeasContext         = 0x15,
    EPAT_PS_PART13_CerrcConnEstContext          = 0x16,
    EPAT_PS_PART13_CerrcConnContext             = 0x17,
    EPAT_PS_PART14_CerrcActStatus               = 0x18,
    EPAT_PS_PART15_CerrcSecurityInfo            = 0x19,

    /* PHY */
    EPAT_PHY_PhyScellInfo      = 0x1a,
    EPAT_PHY_PhySchdCtrlInfo   = 0x1b,
    EPAT_PHY_PhyHwTaskCtrlInfo = 0x1c,
    EPAT_PHY_MacTimerCtr       = 0x1d,
    EPAT_PHY_PhyTxSchdInfo     = 0x1e,
}FlashDumpEnums_e;
...
typedef struct
{
    ...
    uint32_t addr   : 23; /* 23 bits of addr */
    uint32_t len_l7 : 7; /* the low 7 bits of length */
}EcExcepInfoAddr_bm;
...
int excepDumpExcepKeyInfoToFlash(void);
