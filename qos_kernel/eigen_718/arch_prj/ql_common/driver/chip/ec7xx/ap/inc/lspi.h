...
#define LSPI_DMA_BULK_NUM                   (1023*8)
#define LSPI_DMA_DESC_MAX                   (160) // RGB888 man need big desc chain

#define LSPI_FORMAT_RGB565                  (16)
#define LSPI_FORMAT_RGB666                  (18)
#define LSPI_FORMAT_RGB888                  (24)
...
#ifdef UNIRTOS_PLATFORM_MODIFY
  int32_t              (*dma_send)        (uint8_t format, void *data, uint32_t num);
  void                 (*reg_recv)        (uint8_t addr, uint8_t *data, uint16_t dataLen, uint8_t dummyCycleLen);
#endif /* UNIRTOS_PLATFORM_MODIFY */
