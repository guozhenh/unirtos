    ...
    static inline void psa_set_key_id(psa_key_attributes_t *attributes, mbedtls_svc_key_id_t key)
    {
        ...
        if (PSA_KEY_LIFETIME_IS_VOLATILE(lifetime))
        {
            attributes->MBEDTLS_PRIVATE(core).MBEDTLS_PRIVATE(lifetime)
                = PSA_KEY_LIFETIME_FROM_PERSISTENCE_AND_LOCATION(PSA_KEY_LIFETIME_PERSISTENT, PSA_KEY_LIFETIME_GET_LOCATION(lifetime));
        }
    }
...
#define PSA_SIGN_HASH_INTERRUPTIBLE_OPERATION_INIT                                                                                                             \
    ...
    {
        const struct psa_sign_hash_interruptible_operation_s v = PSA_SIGN_HASH_INTERRUPTIBLE_OPERATION_INIT;
...
#define PSA_VERIFY_HASH_INTERRUPTIBLE_OPERATION_INIT                                                                                                           \
    ...
    {
        const struct psa_verify_hash_interruptible_operation_s v = PSA_VERIFY_HASH_INTERRUPTIBLE_OPERATION_INIT;
