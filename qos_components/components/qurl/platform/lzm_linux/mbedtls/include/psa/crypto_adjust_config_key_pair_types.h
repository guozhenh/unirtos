...
#if defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_IMPORT) || defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_EXPORT) || defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_GENERATE)       \
    || defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_DERIVE)
#define PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_BASIC 1
#endif

#if defined(PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_IMPORT) || defined(PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_EXPORT) || defined(PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_GENERATE)       \
    || defined(PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_DERIVE)
#define PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_BASIC 1
#endif

#if defined(PSA_WANT_KEY_TYPE_DH_KEY_PAIR_IMPORT) || defined(PSA_WANT_KEY_TYPE_DH_KEY_PAIR_EXPORT) || defined(PSA_WANT_KEY_TYPE_DH_KEY_PAIR_GENERATE)          \
