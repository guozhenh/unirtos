...
#define PSA_MAX_OF_THREE(a, b, c)                    ((a) <= (b) ? (b) <= (c) ? (c) : (b) : (a) <= (c) ? (c) : (a))
 ...
 *                            return 0.
 */
#define PSA_AEAD_TAG_LENGTH(key_type, key_bits, alg) (PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 ? PSA_ALG_AEAD_GET_TAG_LENGTH(alg) : ((void)(key_bits), 0u))
...
#define PSA_AEAD_ENCRYPT_OUTPUT_SIZE(key_type, alg, plaintext_length)                                                                                          \
    (PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 ? (plaintext_length) + PSA_ALG_AEAD_GET_TAG_LENGTH(alg) : 0u)
...
#define PSA_AEAD_DECRYPT_OUTPUT_SIZE(key_type, alg, ciphertext_length)                                                                                         \
    (PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 && (ciphertext_length) > PSA_ALG_AEAD_GET_TAG_LENGTH(alg)                                                       \
...
#define PSA_AEAD_NONCE_LENGTH(key_type, alg)                                                                                                                    \
    (PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) == 16                                                       ? MBEDTLS_PSA_ALG_AEAD_EQUAL(alg, PSA_ALG_CCM)   ? 13u \
                                                                                                           : MBEDTLS_PSA_ALG_AEAD_EQUAL(alg, PSA_ALG_GCM) ? 12u \
                                                                                                                                                          : 0u  \
     : (key_type) == PSA_KEY_TYPE_CHACHA20 && MBEDTLS_PSA_ALG_AEAD_EQUAL(alg, PSA_ALG_CHACHA20_POLY1305) ? 12u                                                  \
                                                                                                         : 0u)
...
#define PSA_AEAD_UPDATE_OUTPUT_SIZE(key_type, alg, input_length)                                                                                               \
    (PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0                                                                                                                 \
         ? PSA_ALG_IS_AEAD_ON_BLOCK_CIPHER(alg) ? PSA_ROUND_UP_TO_MULTIPLE(PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type), (input_length)) : (input_length)           \
         : 0u)
...
#define PSA_AEAD_FINISH_OUTPUT_SIZE(key_type, alg)                                                                                                             \
    (PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 && PSA_ALG_IS_AEAD_ON_BLOCK_CIPHER(alg) ? PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) : 0u)
...
#define PSA_RSA_MINIMUM_PADDING_SIZE(alg)    (PSA_ALG_IS_RSA_OAEP(alg) ? 2u * PSA_HASH_LENGTH(PSA_ALG_RSA_OAEP_GET_HASH(alg)) + 1u : 11u /*PKCS#1v1.5*/)
...
#if (defined(PSA_WANT_ALG_ECDSA) || defined(PSA_WANT_ALG_DETERMINISTIC_ECDSA)) && (PSA_VENDOR_ECDSA_SIGNATURE_MAX_SIZE > PSA_SIGNATURE_MAX_SIZE)
#undef PSA_SIGNATURE_MAX_SIZE
#define PSA_SIGNATURE_MAX_SIZE PSA_VENDOR_ECDSA_SIGNATURE_MAX_SIZE
#endif
#if (defined(PSA_WANT_ALG_RSA_PKCS1V15_SIGN) || defined(PSA_WANT_ALG_RSA_PSS)) && (PSA_BITS_TO_BYTES(PSA_VENDOR_RSA_MAX_KEY_BITS) > PSA_SIGNATURE_MAX_SIZE)
#undef PSA_SIGNATURE_MAX_SIZE
 ...
 *         return value is unspecified.
 */
#define PSA_ASYMMETRIC_ENCRYPT_OUTPUT_SIZE(key_type, key_bits, alg) (PSA_KEY_TYPE_IS_RSA(key_type) ? ((void)alg, PSA_BITS_TO_BYTES(key_bits)) : 0u)
...
#define PSA_ASYMMETRIC_DECRYPT_OUTPUT_SIZE(key_type, key_bits, alg)                                                                                            \
    (PSA_KEY_TYPE_IS_RSA(key_type) ? PSA_BITS_TO_BYTES(key_bits) - PSA_RSA_MINIMUM_PADDING_SIZE(alg) : 0u)
...
#if defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_BASIC) && (PSA_KEY_EXPORT_ECC_KEY_PAIR_MAX_SIZE(PSA_VENDOR_ECC_MAX_CURVE_BITS) > PSA_EXPORT_KEY_PAIR_MAX_SIZE)
...
#endif
#if defined(PSA_WANT_KEY_TYPE_RSA_KEY_PAIR_BASIC) && (PSA_KEY_EXPORT_RSA_KEY_PAIR_MAX_SIZE(PSA_VENDOR_RSA_MAX_KEY_BITS) > PSA_EXPORT_KEY_PAIR_MAX_SIZE)
#undef PSA_EXPORT_KEY_PAIR_MAX_SIZE
#define PSA_EXPORT_KEY_PAIR_MAX_SIZE PSA_KEY_EXPORT_RSA_KEY_PAIR_MAX_SIZE(PSA_VENDOR_RSA_MAX_KEY_BITS)
#endif
#if defined(PSA_WANT_KEY_TYPE_DH_KEY_PAIR_BASIC) && (PSA_KEY_EXPORT_FFDH_KEY_PAIR_MAX_SIZE(PSA_VENDOR_FFDH_MAX_KEY_BITS) > PSA_EXPORT_KEY_PAIR_MAX_SIZE)
#undef PSA_EXPORT_KEY_PAIR_MAX_SIZE
#define PSA_EXPORT_KEY_PAIR_MAX_SIZE PSA_KEY_EXPORT_FFDH_KEY_PAIR_MAX_SIZE(PSA_VENDOR_FFDH_MAX_KEY_BITS)
#endif
...
#if defined(PSA_WANT_KEY_TYPE_ECC_PUBLIC_KEY) && (PSA_KEY_EXPORT_ECC_PUBLIC_KEY_MAX_SIZE(PSA_VENDOR_ECC_MAX_CURVE_BITS) > PSA_EXPORT_PUBLIC_KEY_MAX_SIZE)
...
#endif
#if defined(PSA_WANT_KEY_TYPE_RSA_PUBLIC_KEY) && (PSA_KEY_EXPORT_RSA_PUBLIC_KEY_MAX_SIZE(PSA_VENDOR_RSA_MAX_KEY_BITS) > PSA_EXPORT_PUBLIC_KEY_MAX_SIZE)
#undef PSA_EXPORT_PUBLIC_KEY_MAX_SIZE
#define PSA_EXPORT_PUBLIC_KEY_MAX_SIZE PSA_KEY_EXPORT_RSA_PUBLIC_KEY_MAX_SIZE(PSA_VENDOR_RSA_MAX_KEY_BITS)
#endif
#if defined(PSA_WANT_KEY_TYPE_DH_PUBLIC_KEY) && (PSA_KEY_EXPORT_FFDH_PUBLIC_KEY_MAX_SIZE(PSA_VENDOR_FFDH_MAX_KEY_BITS) > PSA_EXPORT_PUBLIC_KEY_MAX_SIZE)
#undef PSA_EXPORT_PUBLIC_KEY_MAX_SIZE
...
#define PSA_RAW_KEY_AGREEMENT_OUTPUT_SIZE(key_type, key_bits)                                                                                                  \
    ((PSA_KEY_TYPE_IS_ECC_KEY_PAIR(key_type) || PSA_KEY_TYPE_IS_DH_KEY_PAIR(key_type)) ? PSA_BITS_TO_BYTES(key_bits) : 0u)
...
#if defined(PSA_WANT_ALG_ECDH) && (PSA_BITS_TO_BYTES(PSA_VENDOR_ECC_MAX_CURVE_BITS) > PSA_RAW_KEY_AGREEMENT_OUTPUT_MAX_SIZE)
...
#endif
#if defined(PSA_WANT_ALG_FFDH) && (PSA_BITS_TO_BYTES(PSA_VENDOR_FFDH_MAX_KEY_BITS) > PSA_RAW_KEY_AGREEMENT_OUTPUT_MAX_SIZE)
#undef PSA_RAW_KEY_AGREEMENT_OUTPUT_MAX_SIZE
...
#define PSA_CIPHER_IV_LENGTH(key_type, alg)                                                                                                                    \
    (PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) > 1                                                                                                               \
             && ((alg) == PSA_ALG_CTR || (alg) == PSA_ALG_CFB || (alg) == PSA_ALG_OFB || (alg) == PSA_ALG_XTS || (alg) == PSA_ALG_CBC_NO_PADDING               \
                 || (alg) == PSA_ALG_CBC_PKCS7)                                                                                                                \
         ? PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type)                                                                                                             \
     : (key_type) == PSA_KEY_TYPE_CHACHA20 && (alg) == PSA_ALG_STREAM_CIPHER ? 12u                                                                             \
...
#define PSA_CIPHER_ENCRYPT_OUTPUT_SIZE(key_type, alg, input_length)                                                                                            \
    (alg == PSA_ALG_CBC_PKCS7                                                                                                                                  \
         ? (PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) != 0                                                                                                       \
                ? PSA_ROUND_UP_TO_MULTIPLE(PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type), (input_length) + 1u) + PSA_CIPHER_IV_LENGTH((key_type), (alg))             \
                : 0u)                                                                                                                                          \
         : (PSA_ALG_IS_CIPHER(alg) ? (input_length) + PSA_CIPHER_IV_LENGTH((key_type), (alg)) : 0u))
...
#define PSA_CIPHER_ENCRYPT_OUTPUT_MAX_SIZE(input_length)                                                                                                       \
    (PSA_ROUND_UP_TO_MULTIPLE(PSA_BLOCK_CIPHER_BLOCK_MAX_SIZE, (input_length) + 1u) + PSA_CIPHER_IV_MAX_SIZE)
...
#define PSA_CIPHER_DECRYPT_OUTPUT_SIZE(key_type, alg, input_length)                                                                                            \
    (PSA_ALG_IS_CIPHER(alg) && ((key_type)&PSA_KEY_TYPE_CATEGORY_MASK) == PSA_KEY_TYPE_CATEGORY_SYMMETRIC ? (input_length) : 0u)
...
#define PSA_CIPHER_UPDATE_OUTPUT_SIZE(key_type, alg, input_length)                                                                                             \
    (PSA_ALG_IS_CIPHER(alg)                                                                                                                                    \
         ? (PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) != 0                                                                                                       \
                ? (((alg) == PSA_ALG_CBC_PKCS7 || (alg) == PSA_ALG_CBC_NO_PADDING || (alg) == PSA_ALG_ECB_NO_PADDING)                                          \
 ...
 *                      recognized, or the parameters are incompatible, return 0.
 */
#define PSA_CIPHER_FINISH_OUTPUT_SIZE(key_type, alg)    (PSA_ALG_IS_CIPHER(alg) ? (alg == PSA_ALG_CBC_PKCS7 ? PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) : 0u) : 0u)
