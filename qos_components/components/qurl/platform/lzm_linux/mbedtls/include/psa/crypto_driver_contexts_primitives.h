...
#if defined(MBEDTLS_TEST_LIBTESTDRIVER1) && defined(LIBTESTDRIVER1_MBEDTLS_PSA_BUILTIN_CIPHER)
typedef libtestdriver1_mbedtls_psa_cipher_operation_t mbedtls_transparent_test_driver_cipher_operation_t;

#define MBEDTLS_TRANSPARENT_TEST_DRIVER_CIPHER_OPERATION_INIT LIBTESTDRIVER1_MBEDTLS_PSA_CIPHER_OPERATION_INIT
#else
...
#if defined(MBEDTLS_TEST_LIBTESTDRIVER1) && defined(LIBTESTDRIVER1_MBEDTLS_PSA_BUILTIN_HASH)
typedef libtestdriver1_mbedtls_psa_hash_operation_t mbedtls_transparent_test_driver_hash_operation_t;
