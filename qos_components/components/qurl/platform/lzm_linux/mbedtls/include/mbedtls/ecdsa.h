...
#define MBEDTLS_ECDSA_MAX_SIG_LEN(bits)                                                                                                                        \
    (/*T,L of SEQUENCE*/ ((bits) >= 61 * 8 ? 3 : 2) + /*T,L of r,s*/ 2 * (((bits) >= 127 * 8 ? 3 : 2) + /*V of r,s*/ ((bits) + 8) / 8))
 ...
 */
    int
    mbedtls_ecdsa_verify(mbedtls_ecp_group *grp, const unsigned char *buf, size_t blen, const mbedtls_ecp_point *Q, const mbedtls_mpi *r, const mbedtls_mpi *s);
