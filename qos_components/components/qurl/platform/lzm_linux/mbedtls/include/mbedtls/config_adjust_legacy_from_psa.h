...
#if defined(PSA_WANT_ECC_BRAINPOOL_P_R1_256) && !defined(MBEDTLS_PSA_ACCEL_ECC_BRAINPOOL_P_R1_256)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif

#if defined(PSA_WANT_ECC_BRAINPOOL_P_R1_384) && !defined(MBEDTLS_PSA_ACCEL_ECC_BRAINPOOL_P_R1_384)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif

#if defined(PSA_WANT_ECC_BRAINPOOL_P_R1_512) && !defined(MBEDTLS_PSA_ACCEL_ECC_BRAINPOOL_P_R1_512)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif
...
#if defined(PSA_WANT_ECC_MONTGOMERY_448) && !defined(MBEDTLS_PSA_ACCEL_ECC_MONTGOMERY_448)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#endif

#if defined(PSA_WANT_ECC_SECP_R1_192) && !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_192)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif

#if defined(PSA_WANT_ECC_SECP_R1_224) && !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_224)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif

#if defined(PSA_WANT_ECC_SECP_R1_256) && !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_256)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif

#if defined(PSA_WANT_ECC_SECP_R1_384) && !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_384)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif

#if defined(PSA_WANT_ECC_SECP_R1_521) && !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_521)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif

#if defined(PSA_WANT_ECC_SECP_K1_192) && !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_K1_192)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif

#if defined(PSA_WANT_ECC_SECP_K1_224) && !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_K1_224)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif

#if defined(PSA_WANT_ECC_SECP_K1_256) && !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_K1_256)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES
#endif

/* ECC: algs: is acceleration complete? */
#if defined(PSA_WANT_ALG_DETERMINISTIC_ECDSA) && !defined(MBEDTLS_PSA_ACCEL_ALG_DETERMINISTIC_ECDSA)
...
#if defined(PSA_WANT_KEY_TYPE_ECC_PUBLIC_KEY) && !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_PUBLIC_KEY)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES_BASIC
#endif

#if defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_BASIC) && !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_BASIC)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES_BASIC
#endif

#if defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_IMPORT) && !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_IMPORT)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES
#endif

#if defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_EXPORT) && !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_EXPORT)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES
#endif

#if defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_GENERATE) && !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_GENERATE)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES
#endif
...
#if defined(PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_DERIVE) && !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_DERIVE)
#define MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES
#endif
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_BRAINPOOL_P_R1_256) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_BRAINPOOL_P_R1_384) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_BRAINPOOL_P_R1_512) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_MONTGOMERY_255) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_MONTGOMERY_448) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_192) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_224) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_256) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_384) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_521) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_K1_192) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_K1_224) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_K1_256) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_ALG_DETERMINISTIC_ECDSA) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES)                                        \
...
#if !defined(MBEDTLS_PSA_ACCEL_ALG_ECDH) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES_BASIC)
...
#if !defined(MBEDTLS_PSA_ACCEL_ALG_ECDSA) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_WEIERSTRASS_CURVES)                                                      \
    || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES_BASIC)
...
#if !defined(MBEDTLS_PSA_ACCEL_ALG_JPAKE) || !defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_256) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_KEY_TYPES_BASIC)
...
#if !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_PUBLIC_KEY) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_ALGS)
...
#if !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_BASIC) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES)                                                \
...
#if !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_IMPORT) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES)
...
#if !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_EXPORT) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES)
...
#if !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_GENERATE) || defined(MBEDTLS_PSA_ECC_ACCEL_INCOMPLETE_CURVES)
 ...
 * in the block cipher key types. */
#if (defined(PSA_WANT_ALG_CTR) && !defined(MBEDTLS_PSA_ACCEL_ALG_CTR)) || (defined(PSA_WANT_ALG_CFB) && !defined(MBEDTLS_PSA_ACCEL_ALG_CFB))                   \
    ...
    || (defined(PSA_WANT_ALG_CBC_PKCS7) && !defined(MBEDTLS_PSA_ACCEL_ALG_CBC_PKCS7)) || (defined(PSA_WANT_ALG_CMAC) && !defined(MBEDTLS_PSA_ACCEL_ALG_CMAC))
#define PSA_HAVE_SOFT_BLOCK_MODE 1
#endif

#if (defined(PSA_WANT_ALG_GCM) && !defined(MBEDTLS_PSA_ACCEL_ALG_GCM)) || (defined(PSA_WANT_ALG_CCM) && !defined(MBEDTLS_PSA_ACCEL_ALG_CCM))
...
#if defined(PSA_HAVE_SOFT_KEY_TYPE_AES) || defined(PSA_HAVE_SOFT_BLOCK_MODE) || defined(PSA_HAVE_SOFT_BLOCK_AEAD)
...
#if defined(PSA_HAVE_SOFT_KEY_TYPE_ARIA) || defined(PSA_HAVE_SOFT_BLOCK_MODE) || defined(PSA_HAVE_SOFT_BLOCK_AEAD)
...
#if defined(PSA_HAVE_SOFT_KEY_TYPE_CAMELLIA) || defined(PSA_HAVE_SOFT_BLOCK_MODE) || defined(PSA_HAVE_SOFT_BLOCK_AEAD)
...
#if !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_CHACHA20) || defined(MBEDTLS_PSA_BUILTIN_ALG_STREAM_CIPHER)
 ...
 * situations. */
#if defined(PSA_HAVE_SOFT_KEY_TYPE_AES) || defined(PSA_HAVE_SOFT_KEY_TYPE_ARIA) || defined(PSA_HAVE_SOFT_KEY_TYPE_DES)                                         \
...
#if defined(PSA_HAVE_SOFT_PBKDF2_HMAC) || defined(PSA_HAVE_SOFT_PBKDF2_CMAC)
...
#if !defined(MBEDTLS_PSA_ACCEL_ALG_CBC_NO_PADDING) || defined(PSA_HAVE_SOFT_BLOCK_CIPHER)
...
#if !defined(MBEDTLS_PSA_ACCEL_ALG_CBC_PKCS7) || defined(PSA_HAVE_SOFT_BLOCK_CIPHER)
#define MBEDTLS_CIPHER_MODE_CBC
...
#if !defined(MBEDTLS_PSA_ACCEL_ALG_CCM) || defined(PSA_HAVE_SOFT_KEY_TYPE_AES) || defined(PSA_HAVE_SOFT_KEY_TYPE_ARIA)                                         \
    || defined(PSA_HAVE_SOFT_KEY_TYPE_CAMELLIA)
...
#if !defined(MBEDTLS_PSA_ACCEL_ALG_GCM) || defined(PSA_HAVE_SOFT_KEY_TYPE_AES) || defined(PSA_HAVE_SOFT_KEY_TYPE_ARIA)                                         \
    || defined(PSA_HAVE_SOFT_KEY_TYPE_CAMELLIA)
