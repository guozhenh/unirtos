...
#define MBEDTLS_ASN1_IS_STRING_TAG(tag)                                                                                                                        \
    ((unsigned int)(tag) < 32u                                                                                                                                 \
     && (((1u << (tag))                                                                                                                                        \
          & ((1u << MBEDTLS_ASN1_BMP_STRING) | (1u << MBEDTLS_ASN1_UTF8_STRING) | (1u << MBEDTLS_ASN1_T61_STRING) | (1u << MBEDTLS_ASN1_IA5_STRING)            \
...
#define MBEDTLS_OID_CMP_RAW(oid_str, oid_buf, oid_buf_len) ((MBEDTLS_OID_SIZE(oid_str) != (oid_buf_len)) || memcmp((oid_str), (oid_buf), (oid_buf_len)) != 0)
