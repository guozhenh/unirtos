...
#define MBEDTLS_MPI_UINT_MAX UINT64_MAX
    ...
    && (defined(__amd64__) || defined(__x86_64__) || defined(__ppc64__) || defined(__powerpc64__) || defined(__ia64__) || defined(__alpha__)                   \
        || (defined(__sparc__) && defined(__arch64__)) || defined(__s390x__) || defined(__mips64) || defined(__aarch64__))
#if !defined(MBEDTLS_HAVE_INT64)
#define MBEDTLS_HAVE_INT64
#endif /* MBEDTLS_HAVE_INT64 */
typedef int64_t  mbedtls_mpi_sint;
 ...
 */
#if (!(defined(MBEDTLS_HAVE_INT32) || defined(MBEDTLS_HAVE_INT64))) || (defined(MBEDTLS_HAVE_INT32) && defined(MBEDTLS_HAVE_INT64))
