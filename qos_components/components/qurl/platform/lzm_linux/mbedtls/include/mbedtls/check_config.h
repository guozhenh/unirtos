 ...
 * all 4 of them.
 */
#if defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_PUBLIC_KEY) || defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_BASIC)                                               \
    || defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_IMPORT) || defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_EXPORT)
#if !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_PUBLIC_KEY) || !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_BASIC)                                             \
    || !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_IMPORT) || !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_EXPORT)
...
#if defined(MBEDTLS_PSA_ACCEL_ECC_BRAINPOOL_P_R1_256) || defined(MBEDTLS_PSA_ACCEL_ECC_BRAINPOOL_P_R1_384)                                                     \
    || defined(MBEDTLS_PSA_ACCEL_ECC_BRAINPOOL_P_R1_512) || defined(MBEDTLS_PSA_ACCEL_ECC_MONTGOMERY_255) || defined(MBEDTLS_PSA_ACCEL_ECC_MONTGOMERY_448)     \
    || defined(MBEDTLS_PSA_ACCEL_ECC_SECP_K1_192) || defined(MBEDTLS_PSA_ACCEL_ECC_SECP_K1_224) || defined(MBEDTLS_PSA_ACCEL_ECC_SECP_K1_256)                  \
    || defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_192) || defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_224) || defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_256)                  \
    || defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_384) || defined(MBEDTLS_PSA_ACCEL_ECC_SECP_R1_521)
...
#if defined(MBEDTLS_CMAC_C) && (!defined(MBEDTLS_CIPHER_C) || (!defined(MBEDTLS_AES_C) && !defined(MBEDTLS_DES_C)))
...
#error "MBEDTLS_ECDH_C defined, but not all prerequisites"
    ...
    && (!defined(MBEDTLS_ECP_C)                                                                                                                                \
        || !(                                                                                                                                                  \
            defined(MBEDTLS_ECP_DP_SECP192R1_ENABLED) || defined(MBEDTLS_ECP_DP_SECP224R1_ENABLED) || defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED)                \
            || defined(MBEDTLS_ECP_DP_SECP384R1_ENABLED) || defined(MBEDTLS_ECP_DP_SECP521R1_ENABLED) || defined(MBEDTLS_ECP_DP_SECP192K1_ENABLED)             \
            || defined(MBEDTLS_ECP_DP_SECP224K1_ENABLED) || defined(MBEDTLS_ECP_DP_SECP256K1_ENABLED) || defined(MBEDTLS_ECP_DP_BP256R1_ENABLED)               \
...
#if defined(MBEDTLS_ECJPAKE_C) && (!defined(MBEDTLS_ECP_C) || !(defined(MBEDTLS_MD_C) || defined(MBEDTLS_PSA_CRYPTO_C)))
#error "MBEDTLS_ECJPAKE_C defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_ECP_RESTARTABLE)                                                                                                                           \
    && (defined(MBEDTLS_ECDH_COMPUTE_SHARED_ALT) || defined(MBEDTLS_ECDH_GEN_PUBLIC_ALT) || defined(MBEDTLS_ECDSA_SIGN_ALT)                                    \
        || defined(MBEDTLS_ECDSA_VERIFY_ALT) || defined(MBEDTLS_ECDSA_GENKEY_ALT) || defined(MBEDTLS_ECP_INTERNAL_ALT) || defined(MBEDTLS_ECP_ALT))
...
#error "MBEDTLS_ECDSA_DETERMINISTIC defined, but not all prerequisites"
    ...
    && (!defined(MBEDTLS_BIGNUM_C)                                                                                                                             \
        || (!defined(MBEDTLS_ECP_DP_SECP192R1_ENABLED) && !defined(MBEDTLS_ECP_DP_SECP224R1_ENABLED) && !defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED)             \
            ...
            && !defined(MBEDTLS_ECP_DP_SECP224K1_ENABLED) && !defined(MBEDTLS_ECP_DP_SECP256K1_ENABLED) && !defined(MBEDTLS_ECP_DP_CURVE25519_ENABLED)         \
...
#if defined(MBEDTLS_PKCS5_C) && !defined(MBEDTLS_CIPHER_C)
...
#if defined(MBEDTLS_SHA256_C) || (defined(MBEDTLS_PSA_CRYPTO_C) && defined(PSA_WANT_ALG_SHA_256))
#define MBEDTLS_MD_HAVE_SHA256
#endif
#if defined(MBEDTLS_SHA384_C) || (defined(MBEDTLS_PSA_CRYPTO_C) && defined(PSA_WANT_ALG_SHA_384))
#define MBEDTLS_MD_HAVE_SHA384
#endif
#if defined(MBEDTLS_SHA512_C) || (defined(MBEDTLS_PSA_CRYPTO_C) && defined(PSA_WANT_ALG_SHA_512))
#define MBEDTLS_MD_HAVE_SHA512
#endif

#if defined(MBEDTLS_ENTROPY_C) && !(defined(MBEDTLS_MD_HAVE_SHA512) || defined(MBEDTLS_MD_HAVE_SHA256))
#error "MBEDTLS_ENTROPY_C defined, but not all prerequisites"
#endif
#if defined(MBEDTLS_ENTROPY_C) && defined(MBEDTLS_CTR_DRBG_ENTROPY_LEN) && (MBEDTLS_CTR_DRBG_ENTROPY_LEN > 64)
#error "MBEDTLS_CTR_DRBG_ENTROPY_LEN value too high"
#endif
#if defined(MBEDTLS_ENTROPY_C) && (defined(MBEDTLS_ENTROPY_FORCE_SHA256) || !defined(MBEDTLS_MD_HAVE_SHA512)) && defined(MBEDTLS_CTR_DRBG_ENTROPY_LEN)         \
    && (MBEDTLS_CTR_DRBG_ENTROPY_LEN > 32)
#error "MBEDTLS_CTR_DRBG_ENTROPY_LEN value too high"
#endif
#if defined(MBEDTLS_ENTROPY_C) && defined(MBEDTLS_ENTROPY_FORCE_SHA256) && !defined(MBEDTLS_MD_HAVE_SHA256)
...
#if defined(MBEDTLS_CCM_C) && (!defined(MBEDTLS_AES_C) && !defined(MBEDTLS_CAMELLIA_C) && !defined(MBEDTLS_ARIA_C))
...
#define MBEDTLS_PK_HAVE_CURVE_SECP256R1
    ...
    && (!defined(MBEDTLS_CAN_ECDH) || !defined(MBEDTLS_PK_CAN_ECDSA_SIGN) || !defined(MBEDTLS_X509_CRT_PARSE_C))
#error "MBEDTLS_KEY_EXCHANGE_ECDH_ECDSA_ENABLED defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_KEY_EXCHANGE_ECDH_RSA_ENABLED) && (!defined(MBEDTLS_CAN_ECDH) || !defined(MBEDTLS_RSA_C) || !defined(MBEDTLS_X509_CRT_PARSE_C))
...
#if defined(MBEDTLS_KEY_EXCHANGE_ECDHE_PSK_ENABLED) && !defined(MBEDTLS_CAN_ECDH)
#error "MBEDTLS_KEY_EXCHANGE_ECDHE_PSK_ENABLED defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_KEY_EXCHANGE_DHE_RSA_ENABLED)                                                                                                              \
    && (!defined(MBEDTLS_DHM_C) || !defined(MBEDTLS_RSA_C) || !defined(MBEDTLS_X509_CRT_PARSE_C) || !defined(MBEDTLS_PKCS1_V15))
#error "MBEDTLS_KEY_EXCHANGE_DHE_RSA_ENABLED defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_KEY_EXCHANGE_ECDHE_RSA_ENABLED)                                                                                                            \
    && (!defined(MBEDTLS_CAN_ECDH) || !defined(MBEDTLS_RSA_C) || !defined(MBEDTLS_X509_CRT_PARSE_C) || !defined(MBEDTLS_PKCS1_V15))
...
#if defined(MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED) && (!defined(MBEDTLS_PK_HAVE_JPAKE) || !defined(MBEDTLS_PK_HAVE_CURVE_SECP256R1))
#error "MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED defined, but not all prerequisites"
#endif

/* Use of EC J-PAKE in TLS requires SHA-256. */
#if defined(MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED) && !defined(MBEDTLS_MD_HAVE_SHA256)
#error "MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_KEY_EXCHANGE_WITH_CERT_ENABLED) && !defined(MBEDTLS_SSL_KEEP_PEER_CERTIFICATE)                                                             \
    && (!defined(MBEDTLS_SHA256_C) && !defined(MBEDTLS_SHA512_C) && !defined(MBEDTLS_SHA1_C))
#error "!MBEDTLS_SSL_KEEP_PEER_CERTIFICATE requires MBEDTLS_SHA512_C, MBEDTLS_SHA256_C or MBEDTLS_SHA1_C"
#endif

#if defined(MBEDTLS_MD_C)                                                                                                                                      \
    && !(                                                                                                                                                      \
        defined(MBEDTLS_MD5_C) || defined(MBEDTLS_RIPEMD160_C) || defined(MBEDTLS_SHA1_C) || defined(MBEDTLS_SHA224_C) || defined(MBEDTLS_SHA256_C)            \
        || defined(MBEDTLS_SHA384_C) || defined(MBEDTLS_SHA512_C)                                                                                              \
        || (defined(MBEDTLS_PSA_CRYPTO_C)                                                                                                                      \
            && (defined(PSA_WANT_ALG_MD5) || defined(PSA_WANT_ALG_RIPEMD160) || defined(PSA_WANT_ALG_SHA_1) || defined(PSA_WANT_ALG_SHA_224)                   \
                || defined(PSA_WANT_ALG_SHA_256) || defined(PSA_WANT_ALG_SHA_384) || defined(PSA_WANT_ALG_SHA_512)))                                           \
    )
#error "MBEDTLS_MD_C defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_LMS_C) && !(defined(MBEDTLS_PSA_CRYPTO_C) && defined(PSA_WANT_ALG_SHA_256))
#error "MBEDTLS_LMS_C requires MBEDTLS_PSA_CRYPTO_C and PSA_WANT_ALG_SHA_256"
#endif

#if defined(MBEDTLS_LMS_PRIVATE) && (!defined(MBEDTLS_LMS_C))
...
#if defined(MBEDTLS_PK_C) && !defined(MBEDTLS_RSA_C) && !defined(MBEDTLS_PK_HAVE_ECC_KEYS)
...
#if defined(MBEDTLS_PLATFORM_SETBUF_MACRO) && (defined(MBEDTLS_PLATFORM_STD_SETBUF) || defined(MBEDTLS_PLATFORM_SETBUF_ALT))
...
#if defined(MBEDTLS_PLATFORM_MS_TIME_TYPE_MACRO) && (!defined(MBEDTLS_PLATFORM_C) || !defined(MBEDTLS_HAVE_TIME))
#error "MBEDTLS_PLATFORM_MS_TIME_TYPE_MACRO defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_PLATFORM_MS_TIME_ALT) && (!defined(MBEDTLS_PLATFORM_C) || !defined(MBEDTLS_HAVE_TIME))
...
#if defined(MBEDTLS_PLATFORM_VSNPRINTF_MACRO) && (defined(MBEDTLS_PLATFORM_STD_VSNPRINTF) || defined(MBEDTLS_PLATFORM_VSNPRINTF_ALT))
...
#error "MBEDTLS_PLATFORM_NV_SEED_WRITE_MACRO and MBEDTLS_PLATFORM_STD_NV_SEED_WRITE cannot be defined simultaneously"
    ...
    && !(((defined(MBEDTLS_CTR_DRBG_C) || defined(MBEDTLS_HMAC_DRBG_C)) && defined(MBEDTLS_ENTROPY_C)) || defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG))
#error "MBEDTLS_PSA_CRYPTO_C defined, but not all prerequisites (missing RNG)"
#endif

#if defined(MBEDTLS_PSA_CRYPTO_C) && (defined(PSA_HAVE_SOFT_BLOCK_CIPHER) || defined(PSA_HAVE_SOFT_BLOCK_AEAD)) && !defined(MBEDTLS_CIPHER_C)
...
#if defined(MBEDTLS_PSA_INJECT_ENTROPY) && defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
...
#if defined(MBEDTLS_SHA256_USE_ARMV8_A_CRYPTO_IF_PRESENT) && defined(MBEDTLS_SHA256_USE_ARMV8_A_CRYPTO_ONLY)
...
#if !(                                                                                                                                                         \
    (defined(PSA_WANT_ALG_ECDH) || defined(PSA_WANT_ALG_FFDH)) && defined(MBEDTLS_X509_CRT_PARSE_C)                                                            \
...
#error "MBEDTLS_SSL_PROTO_TLS1_3 defined without MBEDTLS_SSL_KEEP_PEER_CERTIFICATE"
    ...
    && !(                                                                                                                                                      \
        ...
        || defined(MBEDTLS_KEY_EXCHANGE_ECDH_ECDSA_ENABLED) || defined(MBEDTLS_KEY_EXCHANGE_PSK_ENABLED) || defined(MBEDTLS_KEY_EXCHANGE_DHE_PSK_ENABLED)      \
        || defined(MBEDTLS_KEY_EXCHANGE_RSA_PSK_ENABLED) || defined(MBEDTLS_KEY_EXCHANGE_ECDHE_PSK_ENABLED) || defined(MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED)   \
    )
#error                                                                                                                                                         \
    "One or more versions of the TLS protocol are enabled " \
        "but no key exchange methods defined with MBEDTLS_KEY_EXCHANGE_xxxx"
#endif

#if defined(MBEDTLS_SSL_EARLY_DATA)                                                                                                                            \
    && (!defined(MBEDTLS_SSL_SESSION_TICKETS)                                                                                                                  \
        || (!defined(MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_ENABLED) && !defined(MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_EPHEMERAL_ENABLED)))
#error "MBEDTLS_SSL_EARLY_DATA  defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_SSL_EARLY_DATA) && defined(MBEDTLS_SSL_SRV_C) && defined(MBEDTLS_SSL_MAX_EARLY_DATA_SIZE)                                                  \
    && ((MBEDTLS_SSL_MAX_EARLY_DATA_SIZE < 0) || (MBEDTLS_SSL_MAX_EARLY_DATA_SIZE > UINT32_MAX))
...
#if defined(MBEDTLS_SSL_TLS_C) && !(defined(MBEDTLS_CIPHER_C) || defined(MBEDTLS_USE_PSA_CRYPTO))
...
#endif
#else /* MBEDTLS_USE_PSA_CRYPTO */
#if !defined(MBEDTLS_MD_C) || !(defined(MBEDTLS_MD_HAVE_SHA256) || defined(MBEDTLS_MD_HAVE_SHA384))
#error "MBEDTLS_SSL_TLS_C defined, but not all prerequisites"
#endif
#endif /* MBEDTLS_USE_PSA_CRYPTO */
...
#if defined(MBEDTLS_SSL_DTLS_CONNECTION_ID) && (!defined(MBEDTLS_SSL_TLS_C) || !defined(MBEDTLS_SSL_PROTO_DTLS))
#error "MBEDTLS_SSL_DTLS_CONNECTION_ID  defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_SSL_DTLS_CONNECTION_ID) && defined(MBEDTLS_SSL_CID_IN_LEN_MAX) && MBEDTLS_SSL_CID_IN_LEN_MAX > 255
#error "MBEDTLS_SSL_CID_IN_LEN_MAX too large (max 255)"
#endif

#if defined(MBEDTLS_SSL_DTLS_CONNECTION_ID) && defined(MBEDTLS_SSL_CID_OUT_LEN_MAX) && MBEDTLS_SSL_CID_OUT_LEN_MAX > 255
...
#if defined(MBEDTLS_SSL_RENEGOTIATION) && !defined(MBEDTLS_SSL_PROTO_TLS1_2)
#error "MBEDTLS_SSL_RENEGOTIATION defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_SSL_TICKET_C) && (!defined(MBEDTLS_CIPHER_C) && !defined(MBEDTLS_USE_PSA_CRYPTO))
#error "MBEDTLS_SSL_TICKET_C defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_SSL_TICKET_C) && !(defined(MBEDTLS_SSL_HAVE_CCM) || defined(MBEDTLS_SSL_HAVE_GCM) || defined(MBEDTLS_SSL_HAVE_CHACHAPOLY))
#error "MBEDTLS_SSL_TICKET_C defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_SSL_TLS1_3_TICKET_NONCE_LENGTH) && MBEDTLS_SSL_TLS1_3_TICKET_NONCE_LENGTH >= 256
...
#error "MBEDTLS_VERSION_FEATURES defined, but not all prerequisites"
    ...
    && (!defined(MBEDTLS_OID_C) || !defined(MBEDTLS_ASN1_PARSE_C) || !defined(MBEDTLS_PK_PARSE_C)                                                              \
        || (!defined(MBEDTLS_MD_C) && !defined(MBEDTLS_USE_PSA_CRYPTO)))
#error "MBEDTLS_X509_USE_C defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_X509_CREATE_C)                                                                                                                             \
    && (!defined(MBEDTLS_OID_C) || !defined(MBEDTLS_ASN1_WRITE_C) || !defined(MBEDTLS_PK_PARSE_C)                                                              \
        || (!defined(MBEDTLS_MD_C) && !defined(MBEDTLS_USE_PSA_CRYPTO)))
...
#if defined(MBEDTLS_X509_TRUSTED_CERTIFICATE_CALLBACK) && (!defined(MBEDTLS_X509_CRT_PARSE_C))
...
#if defined(MBEDTLS_SSL_CONTEXT_SERIALIZATION) && !(defined(MBEDTLS_SSL_HAVE_CCM) || defined(MBEDTLS_SSL_HAVE_GCM) || defined(MBEDTLS_SSL_HAVE_CHACHAPOLY))
...
#error                                                                                                                                                         \
    "MBEDTLS_SSL_SRV_SUPPORT_SSLV2_CLIENT_HELLO (SSL v2 ClientHello support) was removed in Mbed TLS 3.0. See https://github.com/Mbed-TLS/mbedtls/issues/4031"
#endif

#if defined(MBEDTLS_SSL_TRUNCATED_HMAC_COMPAT)  //no-check-names
#error                                                                                                                                                         \
    "MBEDTLS_SSL_TRUNCATED_HMAC_COMPAT (compatibility with the buggy implementation of truncated HMAC in Mbed TLS up to 2.7) was removed in Mbed TLS 3.0. See https://github.com/Mbed-TLS/mbedtls/issues/4031"
#endif
...
#error "MBEDTLS_SSL_TRUNCATED_HMAC was removed in Mbed TLS 3.0. See https://github.com/Mbed-TLS/mbedtls/issues/4341"
    ...
    && ((!defined(MBEDTLS_ASN1_PARSE_C)) || (!defined(MBEDTLS_OID_C)) || (!defined(MBEDTLS_PK_PARSE_C)) || (!defined(MBEDTLS_X509_CRT_PARSE_C))                \
        || (!defined(MBEDTLS_X509_CRL_PARSE_C)) || (!defined(MBEDTLS_MD_C)))
