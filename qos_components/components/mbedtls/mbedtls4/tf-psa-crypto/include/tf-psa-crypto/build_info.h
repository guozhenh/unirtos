...
#define CONFIG_QCM_MBEDTLS_CONFIG_FILE
/*
...
#include "crypto_raw_config.h"   //Universal
//#include "crypto-config-ccm-psk-tls1_2.h"   // minimal config for TF-PSA-Crypto
// #include "crypto_default_config.h"   //default
#else
//Reference the default configuration file
