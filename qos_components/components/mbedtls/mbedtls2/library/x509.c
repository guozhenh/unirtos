...
int mbedtls_x509_time_is_past( const mbedtls_x509_time *to )
{
    if(ec_mbedtls_check_crt_valid == 1){
        ...
        {
            //ECPLAT_PRINTF(UNILOG_SSL, mbedtls_x509_time_is_past_3, P_VALUE, "get time failed");
            ((void) to);
            return 1;
        }
    }else{
...
int mbedtls_x509_time_is_future( const mbedtls_x509_time *from )
{
    if(ec_mbedtls_check_crt_valid == 1){
        ...
        {
            //ECPLAT_PRINTF(UNILOG_SSL, mbedtls_x509_time_is_future_3, P_VALUE, "get time failed");
            ((void) from);
            return( 0 );
        }
    }else{
