...
#define EAP_STATES                                "Initial", "Pending", "Closed", "Listen", "Identify", "SRP1", "SRP2", "SRP3", "MD5Chall", "Open", "SRP4", "BadAuth"
 ...
 */
    ...
    struct eap_auth
    {
        ...
        qosa_uint32_t       ea_keyflags;             /* SRP shared key usage flags */
    };
...
#define EAP_MAX_CHALLENGE_LENGTH 24
    ...
    typedef struct eap_state
    {
        ...
        qosa_uint8_t es_usepseudo;     /* Use SRP Pseudonym if offered one */
...
#define EAP_DEFALLOWREQ  20 /* max # times to accept requests */
    ...
    extern const struct protent qeap_protent;
