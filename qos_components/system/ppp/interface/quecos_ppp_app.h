/*****************************************************************/ /**
* @brief QuecOS PPP Application Interface Header File
...
*          providing a flexible connection management mechanism.
 ...
 * @details Configures whether to send a termination frame when disconnecting the PPP link.
